 ...
 *
 * Moved here from lib/ui.js, which carried a second copy of formatDate. That
 * copy hardcoded `day: 'numeric'`, so under the `us` preference it rendered
 * 02/6/2026 beside the 02/06/2026 every table cell showed, and its catch
 * returned the raw input where this one returns '-'. Falling through to the
 * formatDate above removes both divergences.
 */
