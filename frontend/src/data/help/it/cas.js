    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'Importa chiave privata', text: 'Collegare la chiave privata di una CA che possiede solo il proprio certificato (firmato da una richiesta esterna), perché possa firmare' },
        ]
      },
      {
