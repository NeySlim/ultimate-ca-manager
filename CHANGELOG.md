...
### Fixed
- The Certificates table named a certificate by its description, which hid its Common Name. The Common Name now comes first with the description under it, and a CSV export keeps both (#365, by @B0F1B0).
